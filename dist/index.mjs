...
function recursiveUpdate(elements, id, callback) {
  ...
  return elements.map((el) => {
    if (el.id === id) {
      return __spreadValues({}, deepMerge(el, callback(el)));
    } else {
      return __spreadProps(__spreadValues({}, el), {
        content: recursiveUpdate(el.content, id, callback)
      });
...
function updateElement(elements, action) {
  ...
  if (action.payload.oldElement.parent === "root") {
    return recursiveUpdate(elements, action.payload.oldElement.id, (element) => {
      return __spreadProps(__spreadValues({}, deepMerge(element, action.payload.newElement)), {
        updatedAt: /* @__PURE__ */ new Date()
      });
    });
  }
...
var WorkspaceContext = React.createContext({
  globalDispatch: () => {
  },
...
var ExportButton = React3.forwardRef((_a, ref) => {
...
function TextElement({ element, dense, className }) {
  ...
  return element.title && /* @__PURE__ */ jsx5(RawEditableText, { callback: updateElement2, className: className || "", text: element.title, dense });
}
...
function ExportWorkspace() {
  ...
  return /* @__PURE__ */ jsx6(export_button_default, { onClick: exportWorkspace });
}
...
import React5, { Suspense } from "react";
...
function LocalStorageSync() {
  ...
  const [date, setDate] = React5.useState(/* @__PURE__ */ new Date());
  const [autoSave, setAutoSave] = React5.useState(true);
  const [sync, setSync] = React5.useState(false);
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      onClick,
      children: [
        /* @__PURE__ */ jsx7("p", { className: "text-xs font-semibold opacity-50 hidden md:inline", children: "sync at:" }),
        /* @__PURE__ */ jsx7(Suspense, { children: /* @__PURE__ */ jsx7(
          "span",
          {
...
import { Loader, Pause, Play, RefreshCcw as RefreshCcw2 } from "lucide-react";
...
var CountdownProvider = ({ children }) => {
  ...
  const [time, setTime] = React6.useState(((_b = (_a = projectState.startedElement) == null ? void 0 : _a.metadata) == null ? void 0 : _b.duration) || maxMinutes);
  const [isActive, setIsActive] = React6.useState(false);
  const [hasFinished, setHasFinished] = React6.useState(false);
  const [minutes, setMinutes] = React6.useState(getMinutes(time));
  const [seconds, setSeconds] = React6.useState(getSeconds(time));
  ...
  return /* @__PURE__ */ jsx8(Context.Provider, { value: {
    minutes,
    seconds,
    hasFinished,
    isActive,
...
function Timer({ element }) {
  ...
  return ((_f = element.metadata) == null ? void 0 : _f.status) !== "FINISHED" && /* @__PURE__ */ jsxs2("div", { className: "flex items-center", children: [
    ((_g = element.metadata) == null ? void 0 : _g.status) === "LINK" && /* @__PURE__ */ jsx9(TimerButton, { onClick: pause, icon: Loader, className: "animate-spin" }),
    ((_h = element.metadata) == null ? void 0 : _h.status) !== "IDLE" && ((_i = element.metadata) == null ? void 0 : _i.status) !== "LINK" && /* @__PURE__ */ jsx9(TimerButton, { onClick: reset, icon: RefreshCcw2 }),
    ((_j = element.metadata) == null ? void 0 : _j.status) !== "ACTIVE" && ((_k = element.metadata) == null ? void 0 : _k.status) !== "LINK" && /* @__PURE__ */ jsx9(TimerButton, { onClick: active, icon: Play }),
    ((_l = element.metadata) == null ? void 0 : _l.status) === "ACTIVE" && /* @__PURE__ */ jsx9(TimerButton, { onClick: pause, icon: Pause })
  ] });
}
function TimerButton({ icon: Icon, onClick, className }) {
  return /* @__PURE__ */ jsx9("button", { onClick, className: clsx_default("p-2 hover:bg-neutral-400/20 rounded-full", className), children: /* @__PURE__ */ jsx9(Icon, { className: "w-4 h-4" }) });
}
...
var Roll = React8.memo(({ value }) => {
  let [a, b] = value.toString();
  if (!b) {
    b = a;
    a = `0`;
  }
  return /* @__PURE__ */ jsxs3("span", { className: "rounded-sm max-h-7 overflow-hidden text-neutral-950/80 flex text-lg font-mono ", children: [
    /* @__PURE__ */ jsx11("div", { className: clsx_default("flex flex-col gap-1 transition-all delay-0", numbers[a || "0"]), children: Object.keys(numbers).map((number, index) => /* @__PURE__ */ jsx11("span", { children: number }, number + 100 + value + index + v4_default())) }),
    /* @__PURE__ */ jsx11("div", { className: clsx_default("flex flex-col gap-1 transition-all delay-0", numbers[b]), children: Object.keys(numbers).map((number, index) => /* @__PURE__ */ jsx11("span", { children: number }, number + index + value + v4_default())) })
  ] });
});
...
var Counterdown = ({ element }) => {
  ...
  const [newTime, setNewTime] = React9.useState({
  ...
  switch ((_e = element.metadata) == null ? void 0 : _e.status) {
    case "ACTIVE":
      ...
      return /* @__PURE__ */ jsxs4("div", { className: "flex items-center", children: [
        /* @__PURE__ */ jsx12(roll_default, { value: minutes }),
        /* @__PURE__ */ jsx12("span", { children: ":" }),
        /* @__PURE__ */ jsx12(roll_default, { value: seconds })
      ] });
    case "LINK":
      if (element.id !== ((_g = projectState.startedElement) == null ? void 0 : _g.id))
        return null;
      return /* @__PURE__ */ jsxs4("div", { className: "flex items-center gap-1 select-none", children: [
        /* @__PURE__ */ jsx12(
          "input",
          {
...
function ElementToolbar({ element }) {
  ...
  return projectState.project && /* @__PURE__ */ jsx13("section", { className: "flex flex-col w-full justify-between", children: /* @__PURE__ */ jsxs5("div", { className: "flex px-2 border rounded-sm mx-2  shadow items-stretch ", children: [
    projectState.openedElement && /* @__PURE__ */ jsx13(Fragment, { children: /* @__PURE__ */ jsx13(
      RawEditableText,
      {
    ...
    /* @__PURE__ */ jsx13("div", { className: "flex items-center w-full select-none gap-1" }),
    /* @__PURE__ */ jsxs5("div", { className: "flex items-center border-l pl-2", children: [
      /* @__PURE__ */ jsx13(countdown_default, { element }),
      /* @__PURE__ */ jsx13(timer_default, { element }),
      /* @__PURE__ */ jsx13(Badge, { variant: "outline", className: "h-6 rounded-sm opacity-80", children: /* @__PURE__ */ jsx13("p", { className: "!text-[10px]  select-none ", children: (_a = element.metadata) == null ? void 0 : _a.status }) })
    ] })
  ] }) });
}
...
var AvatarRaw = React12.forwardRef((_a, ref) => {
  var _b = _a, { style, editable, callback } = _b, props = __objRest(_b, ["style", "editable", "callback"]);
  return /* @__PURE__ */ jsx16("div", { className: "select-none w-fit h-fit overflow-hidden rounded-full ", ref, children: /* @__PURE__ */ jsx16(
    "div",
...
var AvatarEditor = React12.forwardRef((_a, ref) => {
  var props = __objRest(_a, []);
  var _a2, _b;
  const [color, setColor] = React12.useState(emptyColor);
  const handleChangeComplete = (color2) => {
    setColor(color2);
    props.callback && props.callback(color2);
  };
  return /* @__PURE__ */ jsxs7(Fragment2, { children: [
    /* @__PURE__ */ jsx16("span", { className: "w-full flex items-center justify-center ", children: /* @__PURE__ */ jsx16(
      AvatarRaw,
      {
        ref,
...
var AvatarEditable = React12.forwardRef((_a, ref) => {
  var props = __objRest(_a, []);
  const [color, setColor] = React12.useState(void 0);
  const handleChangeComplete = (color2) => {
    setColor(color2);
  };
  const submit = () => props.callback && color && props.callback(color);
  return /* @__PURE__ */ jsxs7(Dialog, { children: [
    /* @__PURE__ */ jsx16(DialogTrigger, { children: /* @__PURE__ */ jsx16(AvatarRaw, __spreadValues({ editable: props.editable ? props.editable : true, ref }, props)) }),
    /* @__PURE__ */ jsx16(DialogPortal, { children: /* @__PURE__ */ jsxs7(DialogContent, { className: "min-h-40", children: [
      /* @__PURE__ */ jsx16(DialogHeader, { children: /* @__PURE__ */ jsx16(DialogTitle, { className: "select-none" }) }),
      /* @__PURE__ */ jsx16(AvatarEditor, __spreadValues({ editable: props.editable ? props.editable : true, callback: handleChangeComplete }, props)),
      /* @__PURE__ */ jsx16(DialogClose, { asChild: true, children: /* @__PURE__ */ jsx16(
        Button,
        {
...
var Avatar = React12.forwardRef((_a, ref) => {
  var props = __objRest(_a, []);
  return props.editable ? /* @__PURE__ */ jsx16(AvatarEditable, __spreadProps(__spreadValues({ ref }, props), { editable: props.editable ? props.editable : true })) : /* @__PURE__ */ jsx16(AvatarRaw, __spreadProps(__spreadValues({ ref }, props), { editable: props.editable ? props.editable : true }));
});
          ...
          "nav",
          {
            ...
            children: [
              /* @__PURE__ */ jsxs8("div", { className: "flex items-center gap-1", children: [
                /* @__PURE__ */ jsx17("span", { className: "flex", children: /* @__PURE__ */ jsxs8(
                  "button",
                  {
                    ...
                    children: [
                      ...
                      projectState.project && /* @__PURE__ */ jsx17("span", { className: "-ml-4", children: /* @__PURE__ */ jsx17(
                        avatar_default,
                        {
                          editable: false,
                          className: "!blur-md ",
                ...
                /* @__PURE__ */ jsx17("button", { onClick: openProjectSettings, className: "opacity-0 group-hover/appbar:opacity-80 p-2  rounded-full hover:bg-neutral-500/10 hover:shadow transition-all", children: /* @__PURE__ */ jsx17(Settings, { className: "w-4 h-4" }) })
              ] }),
              /* @__PURE__ */ jsxs8("div", { className: "flex gap-2  whitespace-nowrap items-center flex-row", children: [
                /* @__PURE__ */ jsx17(localStorage_sync_default, {}),
                projectState.project && /* @__PURE__ */ jsx17(export_project_default, {}),
                !projectState.project && globalState.workspace.content.length > 0 && /* @__PURE__ */ jsx17(export_workspace_default, {})
              ] })
            ]
          }
        ),
        /* @__PURE__ */ jsxs8("div", { className: clsx_default(" h-1/2  flex flex-col justify-between", !projectState.openedElement && "!h-0"), children: [
          projectState.openedElement && /* @__PURE__ */ jsx17(toolbar_default, { element: projectState.openedElement }),
          /* @__PURE__ */ jsx17(Progress, { className: "h-1 z-50", value: 100 - calculateProgress(time, ((_b = (_a = projectState.startedElement) == null ? void 0 : _a.metadata) == null ? void 0 : _b.duration) || 20) })
        ] })
      ]
    }
  );
...
var DashedContainer = React13.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ jsx18(
    ...
    __spreadProps(__spreadValues({
      ...
      children: /* @__PURE__ */ jsx18("div", { className: cn("select-none w-full h-full flex items-center justify-center flex-col gap-1 opacity-70 text-slate-700 group-hover/dashedContainer:opacity-100 transition-all px-1", childClassName), children })
    })
  );
});
...
function ImportProject({ dense = false }) {
  ...
  return /* @__PURE__ */ jsx19(dashed_container_default, { dense, type: dense ? "default" : "shadow", className: "relative overflow-hidden", children: /* @__PURE__ */ jsxs9(
    "label",
    {
      htmlFor: "dropzone-file",
      className: " flex flex-col gap-1 items-center justify-center !cursor-pointer",
      children: [
        /* @__PURE__ */ jsx19(File, { className: "opacity-60" }),
        /* @__PURE__ */ jsx19("p", { className: "text-center px-1", children: "import project" }),
        /* @__PURE__ */ jsx19("input", { onChange: handleImport, id: "dropzone-file", type: "file", className: "cursor-pointer absolute opacity-0 h-[250%]" })
      ]
    }
  ) });
}
...
function ImportWorkspace({ dense = false }) {
  ...
  return /* @__PURE__ */ jsx20(dashed_container_default, { dense, type: dense ? "default" : "shadow", className: "relative !overflow-hidden", children: /* @__PURE__ */ jsxs10(
    "label",
    {
      htmlFor: "dropzone-workspace",
      className: "flex flex-col gap-1 items-center justify-center !cursor-pointer ",
      children: [
        /* @__PURE__ */ jsx20(Folder, { className: "opacity-60" }),
        /* @__PURE__ */ jsx20("p", { className: "text-center", children: "import workspace" }),
        /* @__PURE__ */ jsx20("input", { onChange: handleImport, id: "dropzone-workspace", type: "file", className: "cursor-pointer absolute opacity-0 h-[250%]" })
      ]
    }
  ) });
}
...
var AddProjectBtn = ({ dense = false }) => {
  ...
  return /* @__PURE__ */ jsxs11(dashed_container_default, { dense, onClick: addBoard, className: "!cursor-pointer", children: [
    /* @__PURE__ */ jsx21(Plus, { className: "opacity-60" }),
    /* @__PURE__ */ jsx21("p", { className: "text-center px-1", children: "new project" })
  ] });
};
function CreateProject({ dense = false }) {
  if (dense) {
    return /* @__PURE__ */ jsxs11("div", { className: "w-full h-full grid grid-cols-2 gap-1 grid-rows-2", children: [
      /* @__PURE__ */ jsx21(AddProjectBtn, { dense }),
      /* @__PURE__ */ jsx21(import_project_default, { dense }),
      /* @__PURE__ */ jsx21(import_workspace_default, { dense }),
      /* @__PURE__ */ jsx21(dashed_container_default, { dense, disabled: true, type: "shadow" })
    ] });
  }
  return /* @__PURE__ */ jsxs11("div", { className: clsx_default("flex flex-col items-center justify-center gap-2 w-full my-auto"), children: [
    /* @__PURE__ */ jsx21(AddProjectBtn, {}),
    /* @__PURE__ */ jsxs11("span", { className: "w-full h-full flex gap-2", children: [
      /* @__PURE__ */ jsx21(import_project_default, {}),
      /* @__PURE__ */ jsx21(import_workspace_default, {})
    ] })
  ] });
}
...
import { Plus as Plus2, Text, Group, RectangleHorizontal, RectangleVertical, Folder as Folder2, Ruler, Paintbrush } from "lucide-react";
...
function AddElement(_a) {
  ...
  if (((_c = (_b2 = projectState.startedElement) == null ? void 0 : _b2.metadata) == null ? void 0 : _c.status) === "ACTIVE")
    return /* @__PURE__ */ jsx22("div", { className: "h-10 w-full min-w-[2.1rem]" });
  return /* @__PURE__ */ jsxs12("span", { className: clsx_default("relative group/addElement flex justify-center w-full min-h-12", [dense && "h-fit"]), children: [
    /* @__PURE__ */ jsx22("button", { className: clsx_default("absolute top-0 bottom-0  min-h-8 opacity-0 group-hover/feed:opacity-10  group-hover/addElement:hidden w-full flex items-center justify-center"), children: /* @__PURE__ */ jsx22(Plus2, {}) }),
    /* @__PURE__ */ jsxs12("div", { className: clsx_default("h-full w-full flex items-center min-h-12 justify-center gap-1", dense && "!min-h-fit"), children: [
      opts.feed && /* @__PURE__ */ jsx22(
        Button2,
        {
...
function Button2({
  ...
  return /* @__PURE__ */ jsx22(
    "button",
    {
      ...
      children: /* @__PURE__ */ jsx22(Icon, { className: clsx_default(
...
var Paper = React14.forwardRef((_a, ref) => {
...
function Task(_a) {
  ...
  return /* @__PURE__ */ jsxs13(
    paper_default,
    {
      ...
      children: [
        /* @__PURE__ */ jsx24("span", { className: "flex items-center justify-between w-full gap-1", children: /* @__PURE__ */ jsx24(elements_default, { type: "text", element, raw: true }) }),
        /* @__PURE__ */ jsxs13("div", { className: "h-full w-full px-1 gap-1 flex flex-col py-1", children: [
          Array.isArray(element.content) && element.content.map((el) => /* @__PURE__ */ jsx24(elements_default, __spreadValues({ type: el.type, element: el }, props), el.id)),
          /* @__PURE__ */ jsx24(AddElement, { type: "add", element })
        ] }),
        !dense && /* @__PURE__ */ jsx24("div", { className: "flex items-center justify-between w-full h-fit gap-1", children: /* @__PURE__ */ jsx24("div", { className: "w-full flex justify-end", children: /* @__PURE__ */ jsx24("button", { className: "p-2 rounded-full hover:bg-neutral-900/10 ", children: ((_f = (_e = element.metadata) == null ? void 0 : _e.whenFinish) == null ? void 0 : _f.migrateTo) && /* @__PURE__ */ jsx24(Link, { className: "w-4 h-4" }) }) }) })
      ]
    }
  );
}
...
function GroupElement(_a) {
  var _b = _a, { element, type } = _b, props = __objRest(_b, ["element", "type"]);
  return /* @__PURE__ */ jsxs14(dashed_container_default, { dense: true, type: "shadow", className: "!py-1", childClassName: "!opacity-100 capitalize p-0 px-1", children: [
    /* @__PURE__ */ jsx25(elements_default, { type: "text", element, raw: true, className: "w-full" }),
    Array.isArray(element.content) && element.content.map((content) => /* @__PURE__ */ jsx25(elements_default, __spreadValues({ type: content.type, element: content }, props), content.id)),
    /* @__PURE__ */ jsx25(AddElement, { element, dense: props.dense })
  ] });
}
...
function DragAndDrop({ children, element, disabled, justDrag = false }) {
  var _a;
  const { projectDispatch, projectState } = useWorkspace();
  const [drag, setDrag] = React15.useState(false);
...
var ElementActions = React16.memo(({ element, children, opts }) => {
  ...
  const [select, isSelect] = React16.useState(((_a = projectState.selectedElement) == null ? void 0 : _a.id) == element.id);
  const [minimaze, setMinimaze] = React16.useState(false);
  ...
  return /* @__PURE__ */ jsxs15(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx27("div", { onMouseEnter: selectElement, onMouseLeave: deselectElement, className: clsx_default(
        ...
        ), children: /* @__PURE__ */ jsx27("span", { className: "flex ", children: couldElementBeLinked ? /* @__PURE__ */ jsx27(ActionButton, { color: "blue", onClick: setRef, disabled: !opts.select }) : /* @__PURE__ */ jsxs15(Fragment3, { children: [
          /* @__PURE__ */ jsx27(ActionButton, { color: "red", onClick: () => deleteElement2(element), disabled: !opts.delete }),
          /* @__PURE__ */ jsx27(ActionButton, { color: "orange", onClick: toogleMinimaze, disabled: !opts.minimaze }),
          /* @__PURE__ */ jsx27(ActionButton, { color: "green", onClick: openAndCloseElement, disabled: !opts.minimaze })
        ] }) }) }),
        !minimaze && /* @__PURE__ */ jsx27("div", { className: clsx_default(
        ...
        minimaze && /* @__PURE__ */ jsx27(paper_default, { status: (_j = element.metadata) == null ? void 0 : _j.status, active: !minimaze, children: /* @__PURE__ */ jsx27(elements_default, { className: "text-center w-full !capitalize", type: "text", element, raw: true }) })
      ]
    }
  );
});
function ActionButton({ disabled, onClick, color }) {
  ...
  return !disabled && /* @__PURE__ */ jsxs15("button", { className: clsx_default("z-50 relative flex items-center justify-center p-[.125rem] rounded-full", colorStyle.button), onClick, children: [
    /* @__PURE__ */ jsx27("div", { className: clsx_default("w-3 h-3  rounded-full", colorStyle.div) }),
    /* @__PURE__ */ jsx27("div", { className: "absolute w-2 h-2 bg-white/20 rounded-full" })
  ] });
}
...
function Feed(_a) {
  ...
  return /* @__PURE__ */ jsxs17(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsx29(paper_default, { status: (_a2 = element.metadata) == null ? void 0 : _a2.status, className: clsx_default("absolute z-40 top-0"), children: /* @__PURE__ */ jsx29(
          elements_default,
          __spreadProps(__spreadValues({
            raw: true,
            type: "text",
        ...
        /* @__PURE__ */ jsx29(ScrollArea, { style: props.style, children: /* @__PURE__ */ jsxs17("section", { className: " flex flex-col gap-1 pt-9  bg-slate-200/30 rounded-sm px-1", children: [
          (element.content || []).sort((a, b) => (a.position || 0) - (b.position || 0)).map((el) => /* @__PURE__ */ jsx29(elements_default, __spreadValues({ type: el.type, element: el, parentName: element.id }, props), el.id)),
          /* @__PURE__ */ jsx29(AddElement, { element, parentName: element.id, dense: props.dense })
        ] }) })
      ]
    }
  );
...
import React18, { Fragment as Fragment4 } from "react";
...
var Board = React18.memo((_a) => {
  var _b = _a, { element } = _b, props = __objRest(_b, ["element"]);
  const { globalState, projectState } = useWorkspace();
  if (!projectState.project)
    return null;
  return /* @__PURE__ */ jsx31("div", { className: "flex flex-col w-full h-full", children: /* @__PURE__ */ jsx31("div", { className: clsx_default("w-full h-full flex relative ", globalState.workspace.content.length === 0 && "hidden"), children: /* @__PURE__ */ jsxs18("section", { className: "flex  w-full px-2", children: [
    (element == null ? void 0 : element.content.length) > 0 && /* @__PURE__ */ jsx31(
      ResizablePanelGroup,
      {
        direction: "horizontal",
        className: "items-center justify-center grid-cols-5 gap-1",
        children: element.content.slice(0, 6).filter((el) => el.title !== void 0).map((feed, index) => /* @__PURE__ */ jsxs18(Fragment4, { children: [
          /* @__PURE__ */ jsx31(ResizablePanel, { minSize: 20, className: "h-full pt-2 ", children: /* @__PURE__ */ jsx31(
            elements_default,
            __spreadProps(__spreadValues({}, props), {
              type: feed.type,
              element: feed,
          ...
          index <= element.content.slice(0, 6).length - 2 && /* @__PURE__ */ jsx31(ResizableHandle, { className: "h-full" }, feed.id + index + 100)
        ] }, feed.id + index))
      }
    ),
    /* @__PURE__ */ jsx31("span", { className: clsx_default((element == null ? void 0 : element.content.length) > 0 ? "w-fit h-fit flex pl-1 pt-[.45rem]" : "w-full h-full px-1 flex items-center justify-center transition-all delay-75"), children: /* @__PURE__ */ jsx31(
      AddElement,
      {
        type: "add",
        element,
...
function ElementProject(_a) {
  ...
  return /* @__PURE__ */ jsxs19(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx32("div", { className: "absolute  h-full w-full bg-blue-300/10 opacity-30 ", style: { background: element.style.background, backgroundSize: "200%" } }),
        /* @__PURE__ */ jsx32("div", { className: " py-1 w-full bg-white/20 backdrop-blur-md" }),
        /* @__PURE__ */ jsx32("div", { className: "w-full h-10 bg-white/50 backdrop-blur-md flex items-center transition-all", children: /* @__PURE__ */ jsx32("p", { className: "px-2 w-full line-clamp-2 leading-3 font-semibold select-none text-[11px] m-auto text-neutral-800/70 transition-all", children: element.title }) })
      ]
    }
  );
}
...
function Element(props) {
  switch (props.type) {
    case "avatar":
      if (props.raw)
        return /* @__PURE__ */ jsx34(avatar_default2, __spreadValues({}, props));
      return /* @__PURE__ */ jsx34(DragAndDrop, { element: props.element, justDrag: true, children: /* @__PURE__ */ jsx34(actions_default, __spreadProps(__spreadValues({}, props), { opts: { minimaze: false, select: false }, children: /* @__PURE__ */ jsx34(avatar_default2, __spreadValues({}, props)) })) });
    case "board":
      return /* @__PURE__ */ jsx34(board_default, __spreadValues({}, props));
    case "task":
      if (props.raw)
        return /* @__PURE__ */ jsx34(Task, __spreadValues({}, props));
      return /* @__PURE__ */ jsx34(DragAndDrop, { element: props.element, children: /* @__PURE__ */ jsx34(actions_default, __spreadProps(__spreadValues({}, props), { children: /* @__PURE__ */ jsx34(Task, __spreadValues({}, props)) })) });
    case "add":
      return /* @__PURE__ */ jsx34(AddElement, __spreadValues({}, props));
    case "text":
      if (props.raw)
        return /* @__PURE__ */ jsx34(TextElement, __spreadValues({}, props));
      return /* @__PURE__ */ jsx34(DragAndDrop, { element: props.element, justDrag: true, children: /* @__PURE__ */ jsx34(actions_default, __spreadProps(__spreadValues({ opts: { minimaze: false, select: false } }, props), { children: /* @__PURE__ */ jsx34(TextElement, __spreadValues({}, props)) })) });
    case "group":
      if (props.raw)
        return /* @__PURE__ */ jsx34(GroupElement, __spreadValues({}, props));
      return /* @__PURE__ */ jsx34(DragAndDrop, { element: props.element, children: /* @__PURE__ */ jsx34(actions_default, __spreadProps(__spreadValues({}, props), { children: /* @__PURE__ */ jsx34(GroupElement, __spreadValues({}, props)) })) });
    case "feed":
      if (props.raw)
        return /* @__PURE__ */ jsx34(Feed, __spreadValues({}, props));
      return /* @__PURE__ */ jsx34(DragAndDrop, { element: props.element, children: /* @__PURE__ */ jsx34(actions_default, __spreadProps(__spreadValues({}, props), { children: /* @__PURE__ */ jsx34(Feed, __spreadValues({}, props)) })) });
    case "project":
      return /* @__PURE__ */ jsx34(actions_default, __spreadProps(__spreadValues({}, props), { opts: { minimaze: false, select: false }, children: /* @__PURE__ */ jsx34(project_default, __spreadValues({}, props)) }));
    default:
      return null;
  }
}
...
function ConfigElement({ element }) {
  ...
  return /* @__PURE__ */ jsx35("section", { className: "max-w-screen-lg mx-auto w-full h-full py-8", children: /* @__PURE__ */ jsx35("div", { className: "w-full flex justify-center flex-col max-w-[640px] mx-auto gap-8", children: /* @__PURE__ */ jsx35(
    AvatarEditor,
    {
      callback: changeColor,
      style: {
...
function Workspace() {
  const { globalState, projectState } = useWorkspace();
  return /* @__PURE__ */ jsxs20("section", { className: "h-[100vh] flex flex-col justify-between", children: [
    /* @__PURE__ */ jsx36(appbar_default, {}),
    !globalState.configMode && globalState.workspace.content.length > 0 && /* @__PURE__ */ jsx36("div", { className: clsx_default("h-full max-w-screen-xl mx-auto w-full px-2 flex flex-col", projectState.project && "hidden"), children: /* @__PURE__ */ jsx36("span", { className: "h-1/2 w-full", children: globalState.workspace.content.length > 0 && /* @__PURE__ */ jsxs20("section", { className: "grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 py-6 gap-1 w-full", children: [
      /* @__PURE__ */ jsx36("span", { className: "min-h-44", children: /* @__PURE__ */ jsx36(createProject_default, { dense: true }) }),
      globalState.workspace.content.sort((a, b) => new Date(b.updatedAt).getTime() - new Date(a.updatedAt).getTime()).map((project) => project.type === "project" && /* @__PURE__ */ jsx36(elements_default, { element: project, type: "project" }, project.id + "root"))
    ] }) }) }),
    globalState.workspace.content.length == 0 && !globalState.configMode && /* @__PURE__ */ jsx36("span", { className: "h-full max-w-screen-xl mx-auto w-full px-2 flex", children: /* @__PURE__ */ jsx36(createProject_default, {}) }),
    projectState.project && !projectState.configMode && /* @__PURE__ */ jsx36(elements_default, { element: projectState.project, type: "board" }),
    projectState.project && projectState.configMode && /* @__PURE__ */ jsx36(config_default, { element: projectState.project }),
    !projectState.project && globalState.configMode && /* @__PURE__ */ jsx36(config_default, { element: globalState.workspace }),
    /* @__PURE__ */ jsx36(Footer, {})
  ] });
}
function Footer() {
  return /* @__PURE__ */ jsx36("nav", { className: "select-none flex border-t text-neutral-200  items-center justify-end px-2 max-h-6 min-h-6 w-full " });
}
...
var ToastClose = React19.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ jsx37(
    ...
    __spreadProps(__spreadValues({
      ...
      children: /* @__PURE__ */ jsx37(X2, { className: "h-4 w-4" })
    })
  );
});
...
function Toaster() {
  ...
  return /* @__PURE__ */ jsxs21(ToastProvider, { children: [
    toasts.map(function(_a) {
      ...
      return /* @__PURE__ */ jsxs21(Toast, __spreadProps(__spreadValues({}, props), { children: [
        /* @__PURE__ */ jsxs21("div", { className: "grid gap-1 !select-none", children: [
          title && /* @__PURE__ */ jsx38(ToastTitle, { children: title }),
          description && /* @__PURE__ */ jsx38(ToastDescription, { children: description })
        ] }),
        action,
...
function FlowBoard() {
  return /* @__PURE__ */ jsx39(WorkspaceProvider, { children: /* @__PURE__ */ jsxs22(CountdownProvider, { children: [
    /* @__PURE__ */ jsx39(flowboard_workspace_default, {}),
